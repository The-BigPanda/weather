"""
usage: weather.py [--help] [--config]
   --help    show this help message and exit.
   --config  create or edit configuration file.

Simple Python script to fetches weather data from:
